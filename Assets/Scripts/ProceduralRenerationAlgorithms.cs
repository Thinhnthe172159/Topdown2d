...
public static class ProceduralRenerationAlgorithms
{
    ...
    public static List<BoundsInt> BinarySpacePartitioning(BoundsInt spaceToList, int minWidth, int minHeight)
    {
        Queue<BoundsInt> roomQueue = new Queue<BoundsInt>();
        List<BoundsInt> roomList = new List<BoundsInt>();
        roomQueue.Enqueue(spaceToList);
